...
class fermat:
    ...
    def fermat_potential_arrays(params_dist_wop,params_dist_wp,params_dist_wpl,x_im_test,y_im_test):
    ...
    def fermat_potential_arrays_substructure(params_dist_WoS,params_dist_WS,x_im_test_WoS,x_im_test_WS,y_im_test_WoS,y_im_test_WS):
    ...
    def largest_truth_value(shape,params_dist_wop,params_dist_wp,params_dist_wpl,x_im_test,y_im_test,truth_fermat_potentials):
        truth_arr = []
        sample_wop_arr = []
        sample_wp_arr = []
        sample_wpl_arr = []
        ...
        sampled_fermat_potentials_wop,sampled_fermat_potentials_wp,sampled_fermat_potentials_wpl = fermat.fermat_potential_arrays(
            params_dist_wop,params_dist_wp,params_dist_wpl,x_im_test,y_im_test)
    ...
    def largest_truth_value_substructure(shape,params_dist_WoS,params_dist_WS,x_im_test_WoS,x_im_test_WS,y_im_test_WoS,y_im_test_WS,
        ...
        sampled_fermat_potentials_WoS, sampled_fermat_potentials_WS = fermat.fermat_potential_arrays_substructure(
            params_dist_WoS,params_dist_WS,x_im_test_WoS,x_im_test_WS,y_im_test_WoS,y_im_test_WS)
